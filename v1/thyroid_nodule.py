...
from thyroid_inference import get_prediction   ####This will call your inference file's function get_prediction
...
def find_nodule(input_folder,mode = 'dcm'):
    ...
    ###Here i will send the scan to your function in your .py file and it should return the masks array in original size    
    masks = get_prediction(data)
    masks = masks.astype(np.uint8)
    
    ##This is for post-processing, please check if the following is necessary for your output. It might ot be needed.
